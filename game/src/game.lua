...
function game:setupResources()
    ...
    resourceManager:addAsset(assetGroup(
    {
        fonts = assetGroup(
        {
            ...
            fontTime = {path = "assets/fonts/timefont.png", type = "Image Font", parameters = {glyphs = "0123456789:", spacing = 2}}
        }),
...
function game:setupParticles()
    ...
    local explosionRing = love.graphics.newParticleSystem(circleLine, 100)
