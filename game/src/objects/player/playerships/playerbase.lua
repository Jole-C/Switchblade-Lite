...
function player:setHealthCanRecharge(healthCanRecharge)
    self.healthCanRecharge = healthCanRecharge
end

function player:rechargeHealth(dt)
    if self.healthCanRecharge == false then
        return
    end
