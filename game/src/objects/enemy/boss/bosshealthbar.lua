...
function bossHealthBar:new(bossInstance, name, subtitle)
    ...
    self.barSprite = game.resourceManager:getAsset("Interface Assets"):get("sprites"):get("bossHealth")
    self.barOutlineSprite = game.resourceManager:getAsset("Interface Assets"):get("sprites"):get("bossHealthOutline")
    self.eyeOutlineSprite = game.resourceManager:getAsset("Interface Assets"):get("sprites"):get("bossEyeOutline")
